...
class Program
{
    static void Main()
    {
        ...
        Customer customer1 = new Customer("Atharv");
        Customer customer2 = new Customer("Krishu");

        BankAccount acc1 = bank1.OpenAccount(customer1, 23000);
		BankAccount acc2 = bank2.OpenAccount(customer1, 10000);
        BankAccount acc3 = bank1.OpenAccount(customer2, 5000);
		BankAccount acc4 = bank2.OpenAccount(customer2, 9000);
		Console.WriteLine();
