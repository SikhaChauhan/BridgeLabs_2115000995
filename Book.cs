...
class Program
{
    static void Main()
    {
        ...
        library.AddAtEnd("Gitanjali", "R.B.Tagore", "Fiction", 1);
        library.AddAtEnd("2 States", "Chetan Bhagat", "Fiction", 2);
        library.AddAtBeginning("Half Girlfriend", "Chetan Bhagat", "Fiction", 3);
        ...
        var searchResults = library.SearchByAuthor("Chetan Bhagat");
