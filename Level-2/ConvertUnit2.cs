...
class ConvertUnit2
{
    ...
    static double FahrenToCel(double fahren)
    {
        return (fahren - 32) * 5 / 9;
    }
    // This function converts Celsius to Fahrenheit
    static double CelToFahren(double cel)
    {
        return (cel * 9 / 5) + 32;
    }
