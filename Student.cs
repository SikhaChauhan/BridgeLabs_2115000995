...
class Program
{
    static void Main()
    {
        ...
        Student student1 = new Student("Krishav", 13, "A");
        Student student2 = new Student("Atharv", 14, "B");
        ...
        Console.WriteLine("Changing University Name...\n");
        ...
        Console.WriteLine("Updating Student Grade...\n");
