...
public class VegItem : FoodItem, IDiscountable
{
    ...
    public string GetDiscountDetails()
    {
        ...
        {
            "VEG10" => "10% off on veg items",
            "VEG20" => "20% off on veg items",
...
public class DeliverySystem
{
    public static void Main()
    {
        ...
        order.AddItem(new VegItem("Rajma Chawal", 420, 2, true, true));
        order.AddItem(new VegItem("Dhokla", 199, 1, true, false));
        order.AddItem(new NonVegItem("Chicken Biryani", 189, 1, false, true));
