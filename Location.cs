...
public class RideHailingApp
{
    ...
    public static void Main()
    {
        ...
        app.AddVehicle(new Car("C001", "Krishav", "UP85", "Fortuner", true));
        app.AddVehicle(new Bike("B001", "Reeva", "UP86"));
        app.AddVehicle(new Auto("A001", "Atharv", "UP87"));

        app.BookRide("USER13", "C001", 10.5);
        app.BookRide("USER14", "B001", 5.0);
        app.BookRide("USER15", "A001", 7.5);
    }
}
